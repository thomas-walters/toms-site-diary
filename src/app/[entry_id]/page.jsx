    ...
    <>
      ...
      <div>
        <div className="px-4 sm:px-0">
          <h3 className="text-base font-semibold leading-7 text-gray-900">{entryData?.date}</h3>
      ...
      <Link
        href="/"
        class="border-solid border-2 border-red-500 hover:bg-red-500 hover:text-white text-sm text-red-500 font-bold py-2 px-4 rounded"
      >
        Return
        </Link>
        </>
